...
**Issues.** Flag problems as they happen. Assign a severity, a status, and a category. Issues can be escalated directly to an RFI or change order from inside the log.
...
Thirty days free. Full access. No credit card at signup.

After thirty days it's a monthly subscription. Cancel any time through your account settings — no phone call, no runaround.
